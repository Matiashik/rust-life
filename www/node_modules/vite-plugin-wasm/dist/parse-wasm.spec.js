...
const parse_wasm_js_1 = require("./parse-wasm.js");
...
describe("WASM parser", () => {
    it("should parse `wasm-bindgen` generated WASM files correctly", async () => {
        ...
        expect(await (0, parse_wasm_js_1.parseWasm)(filename)).toStrictEqual({
    ...
    it("should throw error for an invalid WASM file", async () => {
        ...
        await expect((0, parse_wasm_js_1.parseWasm)(filename)).toReject();
    });
});
